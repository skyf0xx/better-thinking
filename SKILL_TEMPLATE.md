...
Every skill lives at `skills/<skill-name>/SKILL.md` and follows this exact structure. Frontmatter is machine-readable (orchestrators route on it); the body is the algorithm.
...
7. **Token budget is enforced:** atomic ≤ 700, composite ≤ 1,500. If a skill can't fit, it's doing too much — split it.
